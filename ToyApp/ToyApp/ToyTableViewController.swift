...
class ToyTableViewController: UITableViewController {
    ...
    func loadToysList(){
            ...
            listener = firestore.collection(collection).order(by: "nome", descending:true).addSnapshotListener(includeMetadataChanges: true, listener: {
                snapshot, error in
            ...
            for document  in snaphot.documents {
                ...
                if let id = data["id"] as? String,
                   ...
                   let telefone = data["telefone"] as? String {
                    let toyItem = ToyItem(id: document.documentID, nome: nome,  estado: estado, doador: doador,
